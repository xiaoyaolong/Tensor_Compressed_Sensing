...
MAKEFILE = Calc_cii3D_8_mex.mk

include Calc_cii3D_8_mex.mki
...
SRC_FILES =  \
	...
	sum.cpp \
	sqrt.cpp \
	Calc_cii3D_8_initialize.cpp \
	Calc_cii3D_8_terminate.cpp \
	Calc_cii3D_8_api.cpp \
	Calc_cii3D_8_mex.cpp

MEX_FILE_NAME_WO_EXT = Calc_cii3D_8_mex
...
SYS_INCLUDE += -I "/Users/ccaiafa/Dropbox/Kronecker\ Inpainting/Test3D/codegen/mex/Calc_cii3D_8"
...
%.$(OBJEXT) : /Users/ccaiafa/Dropbox/Kronecker\ Inpainting/Test3D/codegen/mex/Calc_cii3D_8/%.c
	$(CC) $(CCFLAGS) "$<"



%.$(OBJEXT) : /Users/ccaiafa/Dropbox/Kronecker\ Inpainting/Test3D/codegen/mex/Calc_cii3D_8/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
